...
$out[] = "- [Leasing samochodu z Chin](https://primaauto.com.pl/leasing-samochodu-z-chin/): leasing operacyjny auta z importu, krok po kroku";
...
$out[] = "";
$out[] = "## Leasing samochodu sprowadzanego z Chin";
$out[] = "";
$out[] = "Tak — samochód sprowadzony z Chin można wziąć w leasing operacyjny, a klient nie musi sam szukać firmy leasingowej.";
$out[] = "Prima-Auto proponuje leasingodawcę, który finansuje auta importowane spoza Unii Europejskiej, i prowadzi klienta przez wniosek.";
$out[] = "";
$out[] = "- **Dla kogo:** leasing operacyjny to rozwiązanie dla podmiotów prowadzących działalność gospodarczą (JDG, spółki). Klientom indywidualnym dobierana jest inna forma finansowania.";
$out[] = "- **Wpłata na start:** depozyt zabezpieczający 10% wartości samochodu, wpłacany do Prima-Auto; pozwala zarezerwować i kupić konkretny egzemplarz w Chinach. Kwota depozytu jest zaliczana na poczet opłaty wstępnej leasingu.";
$out[] = "- **Umowa trójstronna:** Prima-Auto sprzedaje samochód firmie leasingowej, która oddaje go klientowi w leasing. Właścicielem auta w trakcie umowy jest firma leasingowa, klient jest korzystającym.";
$out[] = "- **Kolejność:** wybór auta → sprawdzenie egzemplarza w Chinach → umowa organizacji importu w wariancie leasingowym → depozyt → wniosek leasingowy → decyzja → umowa leasingu i umowa trójstronna → zakup, transport i odprawa → zapłata ceny przez leasingodawcę → wydanie auta.";
$out[] = "- **Gdy finansowanie nie ruszy:** realną przyczyną jest zdolność leasingowa po stronie klienta. Jeśli auto nie zostało jeszcze kupione ani zarezerwowane, depozyt wraca w całości w 3 dni robocze, a przy poniesionych udokumentowanych kosztach — po ich rozliczeniu, w 7 dni roboczych.";
$out[] = "- **Czas:** przygotowanie samochodu do wydania trwa orientacyjnie do 120 dni od zakupu auta w Chinach (transport morski, odprawa celna, homologacja indywidualna, rejestracja). Wniosek leasingowy toczy się równolegle i nie wydłuża procesu.";
$out[] = "- **Cena:** firma leasingowa finansuje tę samą kompletną cenę, która widnieje przy aucie w ofercie — z transportem, cłem, VAT-em, homologacją i rejestracją. Na etapie leasingu nie pojawiają się dopłaty za formalności.";
$out[] = "";
