...
- ~~**Galaxy jako osobna marka/sub-brand (od 2025) — DECYZJA Janka 2026-06-19.** NIE mergować make `galaxy` (6579, 17 ofert) do `geely`.~~ **ZASTĄPIONE 2026-07-07:** finalna decyzja Janka = **Galaxy zostaje pod Geely, wzorzec BYD Leopard** (make=geely, sub-marka w nazwie modelu, V61 zostaje). Patrz ADR `2026-07-07-t190-galaxy-pod-geely.md`. (Ówczesna niespójność — `/samochody/galaxy/` 301→geely, e5/starship pod `geely`, m9/a7-em pod `galaxy` — do wyprostowania w T-190 po guardzie importera.)
