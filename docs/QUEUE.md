...
- [ ] **T-115 — Porównywarka aut** 🟡 **MAKIETY ZAAKCEPTOWANE 16.09, do wdrożenia** — spec: `docs/roadmapa/T-115-porownywarka.md`. Porównujemy **wersje** (specid), nie oferty; wzór cpubenchmark, `/porownywarka/`, max 3, noindex, bez logowania, pole wyszukiwania; tabela 4 kolumny z sekcjami karty oferty 1:1 i linkami do słownika; telefon = przewijana tabela z przyklejoną kolumną parametrów (wariant A). Przycisk na karcie oferty = etap 2.
