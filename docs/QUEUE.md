...
- [ ] **T-193b (P2, NOWY — do decyzji Janka) — backfill diakrytyk lead + wiki_body** — kontrola siostrzana T-193 wykryła tę samą regresję poza FAQ: `_asiaauto_lead` serie **132/297** + `asiaauto_wiki_body` serie **42/395** bez diakrytyków (make czyste w obu). Oba user-facing. Ten sam mechanizm co T-193 (subagenty sonnet, gate strict strip==in). Czeka na „bierzemy".
