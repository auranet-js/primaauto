...
> Aktualizacja: 2026-08-20 (**T-246 ZAŁOŻONY 20.08** — wdrożenie poprawek dostępności WCAG 2.2 z audytu 13.08, spec gotowy, osobna sekcja niżej; robota szła dotąd z promptu w `auranet`, w kolejce projektu nie było po niej śladu. Wcześniej 2026-08-07: **T-243 SPEC 07.08, ale ZAPARKOWANY** — dystrybucja treści na social, parasol 8 pozycji, 89–119 h, zużyte 4 h; instrukcja dostępów u Ruslana, **czekamy**; **T-241 wchłonięty** jako faza c. **T-244 i T-245 dopisane 07.08** — dwa defekty zgłoszone w pakiecie T-209 z 06.08, które nigdy nie trafiły do kolejki; T-244 zweryfikowany na produkcji. **Priorytet: T-121 i T-209 — oba mają gotowe pakiety wykonawcze.** Wcześniej: **T-121 ODBLOKOWANY 06.08** — creds produkcyjne PayU, pakiet wykonawczy gotowy, 27–36 h; **T-220 DONE 06.08** — aneks VIN, v0.34.22; **T-242 DONE 06.08** — edycja VIN w zamówieniu, v0.34.21; **T-229 DONE 05.08** — mechanizm rankingów; **T-230 — 7 rankingów LIVE**; **T-238 DONE 05.08** — ceny i tytuły hubów; **T-239 DONE 06.08** — promocja Terenwizja na stronie głównej; **T-240 zaparkowany** — indywidualizacja hubów z własnymi materiałami; **T-241** — procedura „nowe materiały z sesji → hub + reklamy", pierwszy przebieg Leopard 5 na 3 h. Wcześniej: T-217 WDROŻONY 30.07 — v0.34.14; T-219 ZAMKNIĘTY 03.08)
